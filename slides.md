...
- ⚠️ **Примеры** ошибок в runtime *(когда компилятор "молчит")*
...
4. И всё это может приводить к ошибкам, как говорится, "на ровном месте", когда код выглядит чистеньким и красивым, ошибок компиляции нет, никаких хитрых приёмов с типами не применяется, все типы простые, а мы получаем ошибку в runtime. Увидим это на примерах.
-->
---
layout: default
---
...
Для лучшего понимания возможностей и ограничений TypeScript
...
Отчего может сложиться неправильное представление о языке, его возможностях и ограничениях. Я надеюсь, после моего доклада те, кто находится в процессе освоения TypeScript, будут больше обращать внимания на базовые возможности
-->
---
layout: default
---
...
- Плохо типизированна стандартная библиотека JavaScript
